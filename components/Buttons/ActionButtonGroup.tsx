...
import {IconMessage, IconNotification, IconSettingsCog, IconUser} from "@tabler/icons-react";

type ActionButtonProps = { iconSize?: number, orientation?: "vertical" | "horizontal" } & ActionIconProps
