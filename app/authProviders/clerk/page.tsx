...
import {
  ...
  Paper,
  Button,
  useMantineColorScheme, useMantineTheme, parseThemeColor, Select, Flex
} from "@mantine/core";
...
function Home() {
  ...
  const parsedThemeColor = parseThemeColor({color: theme.primaryColor, theme})
  const [clerkTheme, setClerkTheme] = useState<string | null>("");

  const clerkAppearanceOptions: any = {variables: {colorPrimary: parsedThemeColor.value}}
