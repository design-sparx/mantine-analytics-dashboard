            ...
            <Grid gutter={{base: 5, xs: 'md', md: 'xl', xl: 50}}>
              <Grid.Col span={{base: 12, md: 6, lg: 9}}>
                <Stack>
                  ...
                  <Button style={{width: 'fit-content'}} leftSection={<IconDeviceFloppy size={ICON_SIZE}/>}>Save
                    Changes</Button>
                </Stack>
              </Grid.Col>
              <Grid.Col span={{base: 12, md: 6, lg: 3}}>
                <Stack align="center">
                  ...
                  <Text ta="center" size="xs" c="dimmed">For best results, use an image at
